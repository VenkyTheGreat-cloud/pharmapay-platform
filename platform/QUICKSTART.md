# Quick Start Guide - PharmaPay Backend
...
DATABASE_URL=postgresql://postgres:your_password@localhost:5432/pharmapay
...
```bash
psql -U postgres
CREATE DATABASE pharmapay;
\q
```

**Option B: Using createdb command**
```bash
createdb -U postgres pharmapay
```
...
VALUES (
    'Admin User',
    '9876543210',
    'admin@pharmapay.swinkpay-fintech.com',
...
async function createAdmin() {
    ...
    await pool.query(
        `INSERT INTO users (name, mobile, email, password_hash, role, is_active)
         VALUES ($1, $2, $3, $4, $5, $6)`,
        ['Admin User', '9876543210', 'admin@pharmapay.swinkpay-fintech.com', hash, 'admin', true]
    );
    
    console.log('Admin user created!');
    console.log('Email: admin@pharmapay.swinkpay-fintech.com');
...
curl -X POST http://localhost:5000/api/auth/login \
  ...
  -d '{
    "mobileEmail": "admin@pharmapay.swinkpay-fintech.com",
    "password": "admin123"
  }'
```

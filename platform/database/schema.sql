-- PharmaPay Backend - Complete Database Schema
-- PostgreSQL Database
...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'CREATED' CHECK (status IN ('CREATED', 'ASSIGNED', 'ACCEPTED', 'REJECTED', 'PICKED_UP', 'IN_TRANSIT', 'PAYMENT_COLLECTION', 'DELIVERED', 'CANCELLED')),

...
const registerDeliveryBoy = async () => {
  const response = await fetch('https://pharmapay-api.onrender.com/api/auth/register', {
    method: 'POST',
    headers: {
...
const getPendingDeliveryBoys = async () => {
  ...
  const response = await fetch(
    'https://pharmapay-api.onrender.com/api/delivery-boys?status=pending',
    {
      headers: {
...
const approveDeliveryBoy = async (deliveryBoyId, storeId = null) => {
  ...
  const response = await fetch(
    `https://pharmapay-api.onrender.com/api/delivery-boys/${deliveryBoyId}/approve`,
    {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
...
const login = async () => {
  const response = await fetch('https://pharmapay-api.onrender.com/api/auth/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
const PendingDeliveryBoys = () => {
  ...
  const handleApprove = async (id) => {
    ...
    const response = await fetch(
      `https://pharmapay-api.onrender.com/api/delivery-boys/${id}/approve`,
      {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,

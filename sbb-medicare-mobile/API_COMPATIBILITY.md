...
**Backend Implementation:** `/sbb-medicare-backend/src/routes/authRoutes.js`
...
**Backend Implementation:** `/sbb-medicare-backend/src/routes/orderRoutes.js`
...
**Backend Implementation:** `/sbb-medicare-backend/src/routes/paymentRoutes.js`
...
**Backend Implementation:** `/sbb-medicare-backend/src/routes/customerRoutes.js`
...
Check `/sbb-medicare-backend/src/server.js`:
...
1. **Start backend:** `cd sbb-medicare-backend && npm start`
2. **Start mobile app:** `cd sbb-medicare-mobile && npm start`

...
## Endpoint
```
POST https://pharmapay-api.onrender.com/api/access-control
```
...
## cURL Example
```bash
curl -X POST https://pharmapay-api.onrender.com/api/access-control \
...
```javascript
const response = await fetch('https://pharmapay-api.onrender.com/api/access-control', {
  method: 'POST',
  headers: {

        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            ...
            <View style={styles.hero}>
                ...
                <Text style={styles.heroTitle}>
                    Scale your{' '}
                    <Text style={{ color: '#10B981' }}>pharmacy</Text>
                    {'\n'}Empower your{' '}
            ...
            <View style={styles.section}>
                ...
                {/* Pharmacy Owner Card */}
                <View style={[styles.roleCard, { backgroundColor: '#ECFDF5', borderColor: '#A7F3D0' }]}>
                ...
                <View style={[styles.roleCard, { backgroundColor: '#EFF6FF', borderColor: '#BFDBFE' }]}>
            ...
            <View style={[styles.section, { backgroundColor: '#F8FAFC' }]}>
                ...
                <StepCard
                    ...
                    description="Pharmacy owner or delivery partner — pick your path"
                    color="#6366F1"
                    icon="people"
                />
                <StepCard
                    ...
                    description="Create your account, set up branding, and choose your plan"
                    color="#3B82F6"
                    icon="settings"
                />
                <StepCard
                    ...
                    description="Start managing deliveries or earning as a delivery partner"
                    color="#10B981"
                    icon="rocket"
                />
            </View>
...
const styles = StyleSheet.create({
    ...
    badge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#D1FAE5', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, marginBottom: 16, gap: 6 },
    ...
    primaryButton: { backgroundColor: '#10B981', paddingVertical: 16, borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%' },
    ...
    ctaSectionBtn: { backgroundColor: '#10B981', paddingVertical: 16, paddingHorizontal: 32, borderRadius: 14, marginBottom: 16, width: '100%', alignItems: 'center' },
    ctaSectionBtnText: { color: '#fff', fontSize: 16, fontWeight: '700' },
    loginBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', paddingVertical: 14, paddingHorizontal: 24, borderRadius: 14, width: '100%', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.05)' },

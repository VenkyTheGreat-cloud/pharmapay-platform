  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          We, PharmaPay are located at BOOTSTART COWORKING, 3rd Floor, Sanjay Nagar Main Rd, MET Layout, Ashwath Nagar, R.M.V. 2nd Stage, Bengaluru, Karnataka 560094 are herein referred to as SwinkPay Fintech. At SwinkPay Fintech, we value your trust & respect your privacy. This Privacy Policy provides you with the details about the manner in which your data is collected, stored & used by us. You are advised to read this Privacy Policy carefully. By accessing SwinkPay Environment and/or downloading and using the SwinkPay Fintech application you willingly give us consent to use & disclose your personal information in accordance with this Privacy Policy. If you do not agree to the terms of the policy, please do not use or access SwinkPay Fintech.
        </Text>
        <Text style={styles.body}>
          Note: Our privacy policy may change at any time without prior notification. To make sure that you are aware of any changes, kindly review the policy periodically. This privacy policy shall apply uniformly to SwinkPay Fintech applications.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          We will not sell, share, or rent your personal information to any 3rd party or use your email address/mobile number for any unsolicited emails and/or SMS. Any emails and/or SMS sent by SwinkPay Fintech will only be in connection with the provision of agreed services & products and this Privacy Policy. Periodically, we may reveal general statistical information about SwinkPay Fintech and its users, such as number of visitors, number and type of goods and services purchased etc. We reserve the right to communicate your personal information to any third party that makes a legally compliant request for its disclosure.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          SwinkPay Fintech has stringent security measures in place to protect the loss, misuse, and alteration of the information under our control. Whenever you change or access your account information, we offer the use of a secure server. Once your information is in our possession we adhere to strict security guidelines, protecting it against unauthorized access. None of your personal information namely credit card number, expiry date etc. is stored in SwinkPay Fintech or in our servers as a clear text but only as an encrypted data that cannot be accessed or read by any individual or application.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.body}>
          By using SwinkPay Fintech and/or by providing your information, you consent to the collection and use of the information you disclose on SwinkPay Fintech in accordance with this privacy policy, including but not limited to your consent for sharing your information as per this privacy policy.
        </Text>
      </View>

# Frontend Integration Guide - PharmaPay Backend APIs

## Base URL
```
Production: https://pharmapay-api.onrender.com
...
### Test Create Order
```bash
curl -X POST https://pharmapay-api.onrender.com/api/orders \
...
### Test Export Excel
```bash
curl -X GET "https://pharmapay-api.onrender.com/api/orders/export/excel?date=2026-01-28&from_time=09:00&to_time=18:00" \
  -H "Authorization: Bearer YOUR_TOKEN" \
  --output orders.xlsx
```

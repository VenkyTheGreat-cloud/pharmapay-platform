# SBB Medicare - Admin Dashboard

Admin dashboard for managing delivery boys, viewing orders, and monitoring the SBB Medicare order and delivery management system.
...
The admin dashboard connects to the SBB Medicare backend API. Make sure the backend is running before starting the admin dashboard.

...
// Base URL for PharmaPay backend
...
// Response interceptor to handle 401 / auth errors with automatic token refresh
...
let mockDeliveryBoys = [
    {
        ...
        name: 'Sanjay Verma',
        mobile: '9988776655',
        email: 'sanjay@pharmapay.com',
        address: 'BTM Layout, Bangalore',
        photoUrl: 'https://cdn.pharmapay.com/profiles/sanjay.jpg',
        status: 'approved',
        isActive: true,
    ...
    get: async () => {
        ...
        return {
            data: {
                success: true,
                data: {
                    qrMerchantVPA: 'pharmapay@paytm',
                    support: {
                        phone: '+91-9876543210',
                        email: 'support@pharmapay.com',
                    },
                    features: {

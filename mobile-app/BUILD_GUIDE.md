...
git clone https://github.com/VenkyTheGreat-cloud/pharmapay.git
cd pharmapay/mobile-app
...
```
**Answer:** Just press **Enter** (already set to `com.pharmapay.delivery`)
...
Build started!
View build details: https://expo.dev/accounts/YOUR-ACCOUNT/projects/mobile-app/builds/...
...
- ✅ **Backend API:** `https://pharmapay-api.onrender.com/api`
- ✅ **Package name:** `com.pharmapay.delivery`
...
- **Your Backend:** https://pharmapay-api.onrender.com/api

...
The PharmaPay Backend server should now be running on **http://localhost:5000**
...
### 2. Start the Server
```powershell
cd "d:\SwinkPay-Workspace\PharmaPay\PharmaPay-Niranjan-Branch\pharmapay\platform"
node src/server.js
```
...
- Create database: `createdb -U postgres pharmapay`

# PharmaPay - Store Dashboard

Store dashboard for managing delivery boys, viewing orders, and monitoring the PharmaPay order and delivery management system.
...
The store dashboard connects to the PharmaPay backend API. Make sure the backend is running before starting the admin dashboard.

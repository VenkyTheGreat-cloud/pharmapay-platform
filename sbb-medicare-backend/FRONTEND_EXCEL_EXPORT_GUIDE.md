...
```bash
# Test with curl
curl -X GET "https://sbb-medicare-api.onrender.com/api/reports/sales?format=excel&from_date=2026-01-10&from_time=00:00:00&to_date=2026-02-10&to_time=23:59:59" \
